...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_maukkaasti_syominen_ei_vie_saldoa_negatiiviseksi(self):
        kortti = Maksukortti(200)
    ...
    def test_kortilla_pystyy_ostamaan_tasarahalla_edullisen_lounaan(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(kortti.saldo_euroina(), 0)

    def test_kortilla_pystyy_ostamaan_tasarahalla_maukkaan_lounaan(self):
