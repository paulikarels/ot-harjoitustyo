...
def create_courses():
    ...
    for i in range(1, 11):
        ...
        cursor.execute('''INSERT INTO courses (id, userID, title, credits, created_at)
                       VALUES (?, ?, ?, ?, ?)''',
                        (i, 222, course_title, credits_amount, created_at))
...
def create_exercises():
    ...
    for i in range(1, 11):
        ...
        for j in range(1, 11):
            ...
            cursor.execute('''INSERT INTO exercises (courseID, description, done, marked_done_at)
                           VALUES (?, ?, ?, ?)''',
